        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <h1 className="hero-title font-extrabold mb-6 text-5xl md:text-7xl tracking-tight leading-[1.1]">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 inline-block">Master Your</span>
              <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 inline-block">Academic Journey</span>
            </h1>
