...
const StatCard = memo(function StatCard({
  ...
  return (
    <motion.div variants={fadeUp}>
      <Card className="premium-card p-5 text-center h-full border-0 rounded-2xl">
...
const ToolCard = memo(function ToolCard({
  ...
  return (
    <motion.div variants={fadeUp} className="relative z-10">
      <Card
        className="premium-card p-6 h-full cursor-pointer border-0 rounded-2xl group/card flex flex-col justify-between"
    ...
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <section id="features" className="py-20 md:py-24 relative" aria-labelledby="features-heading">
        <div className="container">
          ...
          >
            <Card
              className="glow-border-card p-8 md:p-12 cursor-pointer border-0 rounded-3xl"
